...
<style type="text/css">
body {
  background: url("images/xyz.jpg") no-repeat center center fixed;
...
<body>
	<div style="text-align: center;">
		<h1 style="color: blue;align-self: center;">Kính chào quý khách</h1>
		<form class="formContact" action="buy.htm" method="get">

			<h2 style="align-self: center; color: blue;">Mua Hàng</h2>
